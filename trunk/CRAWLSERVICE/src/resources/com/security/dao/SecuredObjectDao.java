package resources.com.security.dao;
...
public class SecuredObjectDao {
    ...
    public static final String DEF_ROLES_AND_URL_QUERY =
             "SELECT A.RESO_PTN AS URL		\n"
            +"      ,B.AUTH_ID AS AUTHORITY	\n"
            +"  FROM RESO_INFO A			\n"
            +"      ,RESO_AUTH B			\n"
            +" WHERE A.RESO_ID = B.RESO_ID	\n"
            +"   AND A.RESO_TP = 'url'		\n"
            +" ORDER BY A.RESO_ORD			\n";
    ...
    public static final String DEF_ROLES_AND_METHOD_QUERY =
            "SELECT A.RESO_PTN AS METHOD	\n"
           +"      ,B.AUTH_ID AS AUTHORITY	\n"
           +"  FROM RESO_INFO A				\n"
           +"      ,RESO_AUTH B				\n"
           +" WHERE A.RESO_ID = B.RESO_ID	\n"
           +"   AND A.RESO_TP = 'method'	\n"
           +" ORDER BY A.RESO_ORD			\n";
    ...
    public static final String DEF_ROLES_AND_POINTCUT_QUERY =
            "SELECT A.RESO_PTN AS POINTCUT	\n"
           +"      ,B.AUTH_ID AS AUTHORITY	\n"
           +"  FROM RESO_INFO A				\n"
           +"      ,RESO_AUTH B				\n"
           +" WHERE A.RESO_ID = B.RESO_ID	\n"
           +"   AND A.RESO_TP = 'pointcut'	\n"
           +" ORDER BY A.RESO_ORD			\n";
    ...
    public static final String DEF_REGEX_MATCHED_REQUEST_MAPPING_QUERY_ORACLE10G =
            ...
            +"                          FROM (																\n"
            +"                                SELECT RESOURCE_ID											\n"
            +"                                      ,ROW_NUMBER() OVER (ORDER BY SORT_ORDER) RESOURCE_ORDER	\n"
    ...
    public static final String DEF_HIERARCHICAL_ROLES_QUERY =
		    ...
		    +"      ,Z.PARENT											\n"
		    +"  FROM (													\n"
		    +"        SELECT A.CHILD_AUTH_ID AS CHILD					\n"      
		    +"              ,A.PARENT_AUTH_ID AS PARENT					\n"  
		    +"          FROM AUTH_LVL A									\n"  
		    +"          LEFT JOIN AUTH_LVL B							\n"         
		    +"                 ON A.CHILD_AUTH_ID = B.PARENT_AUTH_ID	\n"
		    +"       ) Z												\n"
		    +" GROUP BY Z.CHILD											\n"
		    +"         ,Z.PARENT										\n";
    ...
    public LinkedHashMap<Object, List<ConfigAttribute>> getRolesAndResources(String resourceType) throws Exception {
        ...
        System.out.println("sqlRolesAndResources : \n"+sqlRolesAndResources);
        ...
        while (itr.hasNext()) {
            ...
            System.out.println("authority : "+ presentResource +" = "+ tempMap.get("authority"));
    ...
    public String getHierarchicalRoles() throws Exception {
        ...
        System.out.println("getSqlHierarchicalRoles() : \n"+getSqlHierarchicalRoles());
        ...
        System.out.println("concatedRoles : \n"+concatedRoles.toString());
