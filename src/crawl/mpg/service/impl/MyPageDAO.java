...
public class MyPageDAO {
	/** log */
    protected static final Log LOG = LogFactory.getLog(MyPageDAO.class);
    
    @Autowired
	private SqlMapClient sql;

    public VoUserInfo selectUserInfoByUserId(HashMap<String, String> hMap) throws Exception{
    	return (VoUserInfo) sql.queryForObject("myPageDAO.selectUserInfoByUserId", hMap);
    }
    ...
    public void updateUserInfoByUserIdPW(HashMap<String, String> hMap) throws Exception{
		...
		try {
			sql.update("myPageDAO.updateUserInfoByUserIdPW", hMap);
			// Transaction Commit!!
			sql.commitTransaction(); 
			// connection Commit!!
